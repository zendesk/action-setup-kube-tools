    ...
    if (!cachedToolPath) {
        ...
        try {
            ...
            if (tool.isArchived) {
                ...
                const extractedDirPath = await toolCache.extractTar(packagePath, extractTarBaseDirPath);
        ...
        cachedToolPath = await toolCache.cacheFile(commandPath, tool.name, tool.name, version);
